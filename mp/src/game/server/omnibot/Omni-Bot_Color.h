...
public:
	...
	{
		return cdata.mRGBA[ 0 ];
	}
	inline uint8_t g() const
	{
		return cdata.mRGBA[ 1 ];
	}
	inline uint8_t b() const
	{
		return cdata.mRGBA[ 2 ];
	}
	inline uint8_t a() const
	{
		return cdata.mRGBA[ 3 ];
	}

	inline float rF() const
	{
		return (float)cdata.mRGBA[ 0 ] / 255.0f;
	}
	inline float gF() const
	{
		return (float)cdata.mRGBA[ 1 ] / 255.0f;
	}
	inline float bF() const
	{
		return (float)cdata.mRGBA[ 2 ] / 255.0f;
	}
	inline float aF() const
	{
		return (float)cdata.mRGBA[ 3 ] / 255.0f;
	}

	inline obColor fade( uint8_t _a ) const
	{
		obColor c( cdata.mRGBAi ); c.cdata.mRGBA[ 3 ] = _a; return c;
	}
	...
	inline int32_t rgba() const
	{
		return cdata.mRGBAi;
	}
	inline int32_t argb() const
	{
